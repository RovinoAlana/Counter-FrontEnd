            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <Card className="bg-yellow-50 border-yellow-200">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <h3 className="text-3xl font-bold text-yellow-900 mt-1"></h3>
                            </div>
                    ...
                    <Card className="bg-green-50 border-green-200">
                        <div className="fkex justify-between items-start">
                            <div>
                                <p className="text-green-800 text-sm font-medium">Selesai</p>
                                <h3 className="text-3xl font-bold tex-green-900 mt-1">5</h3>
                            </div>
